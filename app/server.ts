...
import VentasRoute from "./componets/ventas/api/venta.api";
import OpcionesRoute from "./componets/opciones/api/opciones.api";
...
export class Servidor {
  ...
  routes(): void {
    ...
    this.app.use("/opciones", OpcionesRoute);
  }
